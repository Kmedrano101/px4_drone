#!/bin/bash
# $1 = preflight | approach | scanloss. Aislado: ROS_DOMAIN_ID 77 y solo localhost,
...
wait $MOCK
echo "--- nodo (/tmp/node_$1.log):"; grep -E "NO SE ARMA|OBSTACULO|Aterrizando|ARMADO" /tmp/node_$1.log
